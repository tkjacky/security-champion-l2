...
CREATE DATABASE IF NOT EXISTS secchamp2025;
...
-- Insert sample users with working BCrypt hashes
-- Alice: password123 -> $2b$12$ufLkAVLAqAPzGaaYZ5aVx.ESpO48OkAvsETwJuRR6vmrqQVWMGL3e
-- Admin: admin123 -> $2b$12$v9ZJ20m7./mvxIEg1n/T1uBN0S1bE1eexitGC29z4CXJtlS..jF6C
-- Test: test123 -> $2b$12$Ck4dpLIYlWwep7SCFDkFcOWa7p8niF.Ne2I13yPYlOYrIofIPI4ZG
...
('1', 'Alice', '+155501001', 'alice@secchamp.com', '$2b$12$ufLkAVLAqAPzGaaYZ5aVx.ESpO48OkAvsETwJuRR6vmrqQVWMGL3e', '123 Main St, Springfield', 'USER', FALSE, 'ACTIVE', 500.00),
('2', 'Admin User', '+155501002', 'admin@secchamp.com', '$2b$12$v9ZJ20m7./mvxIEg1n/T1uBN0S1bE1eexitGC29z4CXJtlS..jF6C', '456 Admin Ave, Springfield', 'ADMIN', TRUE, 'ACTIVE', 10000.00),
('3', 'Test Manager', '+155501003', 'test@secchamp.com', '$2b$12$Ck4dpLIYlWwep7SCFDkFcOWa7p8niF.Ne2I13yPYlOYrIofIPI4ZG', '789 Test Blvd, Springfield', 'MANAGER', FALSE, 'ACTIVE', 2000.00),
...
CREATE TABLE IF NOT EXISTS purchase_sessions (
    ...
    book_id VARCHAR(50) NULL, -- Now nullable for cart-based sessions
    cart_id VARCHAR(50) NULL, -- Reference to shopping cart
...
-- Create user_books table for books owned by users
CREATE TABLE IF NOT EXISTS user_books (
    ...
    FOREIGN KEY (user_id) REFERENCES users(id),
    FOREIGN KEY (book_id) REFERENCES books(id)
    -- Note: Removed unique constraint to allow multiple copies of the same book
);
...
-- Insert sample user book ownership
...
INSERT INTO book_reviews (id, book_id, user_id, rating, review_title, review_text, helpful_count, verified_purchase) VALUES
('1', '1', '1', 5.0, 'Excellent Architecture Guide', 'This book provides clear and practical guidance on building maintainable software systems. The examples are well-structured and easy to follow.', 15, TRUE),
('2', '2', '4', 4.5, 'Great DevOps Story', 'Fantastic narrative that makes complex DevOps concepts accessible. Really helped me understand the business value of IT operations.', 8, TRUE),
('3', '3', '1', 4.0, 'Solid Security Foundation', 'Good coverage of cybersecurity fundamentals. Could use more practical examples, but overall very informative.', 12, TRUE),
('4', '4', '1', 5.0, 'Spring Boot Masterpiece', 'Comprehensive guide to Spring Boot. Everything you need to know to build production-ready applications.', 22, TRUE),
('5', '7', '4', 4.0, 'JavaScript Essentials', 'Concise and focused on the important parts of JavaScript. A must-read for any web developer.', 18, TRUE),
('6', '8', '5', 5.0, 'System Design Bible', 'Incredibly detailed and well-organized. Perfect preparation for system design interviews at top tech companies.', 35, FALSE),
('7', '10', '5', 4.5, 'Security Best Practices', 'Excellent coverage of secure coding practices. Very relevant for modern web development.', 9, FALSE),
('8', '1', '4', 4.0, 'Clean and Clear', 'Great book on software architecture principles. Some concepts could be explained more simply, but overall very valuable.', 6, FALSE),
('9', '11', '1', 4.5, 'Microservices Done Right', 'Excellent patterns and real-world examples. Helps avoid common microservices pitfalls.', 14, TRUE),
('10', '12', '5', 4.0, 'Modern React Development', 'Good introduction to modern React patterns. Covers hooks and context very well.', 7, FALSE);