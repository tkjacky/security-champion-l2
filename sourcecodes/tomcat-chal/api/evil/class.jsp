...
<%
    // This JSP serves compiled Java class files for dynamic loading (evil namespace)
    ...
    // Allow evil classes from this endpoint
    if (!className.startsWith("evil.")) {
        response.setStatus(403);
        out.print("Error: Only evil classes are served from this endpoint");
        return;
    }
